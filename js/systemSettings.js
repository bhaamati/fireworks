...
SystemSettings.risingTailFireworks = generateGenericSystemConfig(
    RisingTailFireworksInitializer, RisingTailFireworksUpdater, "risingTailFireworks"
);
...
SystemSettings.crossFireworks = generateGenericSystemConfig(
 ...
 * too much hassle :-)
 */
function generateGenericSystemConfig(initializer, updater, systemSettingName) {
    return {
        // Particle Material
        particleMaterial :  SystemSettings.standardMaterial,
        ...
        systemSettingName: systemSettingName
